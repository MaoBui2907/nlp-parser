...
NP[rn=?x, jj=?y, in=?z] -> NN[rn=?x, jj=?y, in=?z] NN[rn=?x, jj=?y, in=?z]

NP[rn=?x, jj=?y, in=?z] -> NP1[rn=?x] PP[]
NP[rn=?x, jj=?y, in=?z] -> NP1[rn=?x, jj=?y, in=?z] JJ[rn=?x, jj=?y, in=?z]
...
tests = ["con chó của tôi chơi trên bãi cỏ"]
